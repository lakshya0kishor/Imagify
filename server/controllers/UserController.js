...
const registerUser = async (req, res) => {
    try {
        ...
        const userData = {
            ...
            creditBalance: 5  // Set default credits to 5
        };
...
const loginUser = async (req, res) => {
    try {
        ...
        if (isMatch) {
            ...
            // Set default credits to 5 if they are not already set to 5
            // if (user.creditBalance !== 5) {
            //     await userModel.findByIdAndUpdate(user._id, { creditBalance: 5 });
            // }
